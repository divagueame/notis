...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post newspapers_url, params: { newspaper: { newspaperCssSelector: @newspaper.newspaperCssSelector, newspaperName: @newspaper.newspaperName, newspaperUrl: @newspaper.newspaperUrl } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { newspaperCssSelector: @newspaper.newspaperCssSelector, newspaperName: @newspaper.newspaperName, newspaperUrl: @newspaper.newspaperUrl } }
